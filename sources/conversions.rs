...
impl_from_for_Value_3! (Path, Path, fs_path::PathBuf, value, Path::new_from_buffer (value));
impl_from_for_Value_3! (Path, Path, &'static fs_path::Path, value, Path::new_from_ref (value));

impl_from_for_type! (Path, StdString, value, Path::new_from_buffer (fs_path::PathBuf::from (value)));
impl_from_for_type! (Path, &'static str, value, Path::new_from_ref (fs_path::Path::new (value)));

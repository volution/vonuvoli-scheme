...
fn __parse_value_full<'input>(
    ...
    __pos: usize,
) -> RuleResult<values::Value> {# ! [ allow ( non_snake_case , unused ) ]    __parse_value(__input, __state, __pos)
}
                            ...
                            Failed => {
                                ...
                                match __choice_res {
                                    ...
                                    Failed => {
                                        ...
                                        match __choice_res {
                                            Matched(__pos, __value) => Matched(__pos, __value),
                                            Failed => __parse_bytes(__input, __state, __pos),
                                        }
                                    }
                                }
                            }
                                ...
                                match __seq_res {
                                    Matched(__pos, _) => {
                                        ...
                                        match __seq_res {
                                            Matched(__pos, _) => {
                                                Matched(__pos, {
                                                    values::list_from_slice(elements.as_slice())
                                                })
                                            }
                                            Failed => Failed,
                                        }
                                                                ...
                                                                match __seq_res {
                                                                    Matched(__pos, _) => {
                                                                        ...
                                                                        match __seq_res {
                                                                            Matched(__pos, _) => {
                                                                                Matched(__pos, {
                                                                                    values::list_from_slice_2 (elements.as_slice (), last)
                                                                                })
                                                                            }
                                                                            Failed => Failed,
                                                                        }
                                ...
                                match __seq_res {
                                    Matched(__pos, _) => {
                                        ...
                                        match __seq_res {
                                            Matched(__pos, _) => {
                                                Matched(__pos, {
                                                    values::array_from_slice(elements.as_slice())
                                                })
                                            }
                                            Failed => Failed,
                                        }
...
fn __parse_number_real_variant_1<'input>(
    ...
    __pos: usize,
        ...
        match __seq_res {
            Matched(__pos, value) => {
                match {
                    f64::from_str(value).map(values::number_real).map_err(
                        |_| "invalid real syntax",
                    )
                } {
                    Ok(res) => Matched(__pos, res),
                    Err(expected) => {
                        ...
                        match __seq_res {
                            Matched(__pos, _) => {
                                ...
                                match __seq_res {
                                    Matched(__pos, _) => {
                                        Matched(__pos, {
                                            values::number_real(f64::INFINITY)
                                        })
                                    }
                                    Failed => Failed,
                                }
                        ...
                        match __seq_res {
                            Matched(__pos, _) => {
                                ...
                                match __seq_res {
                                    Matched(__pos, _) => {
                                        Matched(__pos, {
                                            values::number_real(f64::NEG_INFINITY)
                                        })
                                    }
                                    Failed => Failed,
                                }
                ...
                match __seq_res {
                    Matched(__pos, elements) => {
                        ...
                        match __seq_res {
                            Matched(__pos, _) => {
                                Matched(__pos, {
                                    values::string_from_slice(elements.as_slice())
                                })
                            }
                            Failed => Failed,
                        }

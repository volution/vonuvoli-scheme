...
\part{Description of the language}
...
along with the alternatives \sharptrue and \sharpfalse.
...
\begin{entry}{
\pproto{(\hyper{operator} \hyperi{operand} \ldots)}{\exprtype}}
...
\item {\tt(\hyperi{variable} \ldots \hyper{variable$_{n}$}\ {\bf.}\
...
\label{inclusion}
\begin{entry}{
\proto{include}{ \hyperi{string} \hyperii{string} \ldots}{\exprtype}
\rproto{include-ci}{ \hyperi{string} \hyperii{string} \ldots}{\exprtype}}
...
\begin{entry}{
\proto{cond}{ \hyperi{clause} \hyperii{clause} \ldots}{\exprtype}
...
\begin{scheme}
(\hyper{test} \hyperi{expression} \ldots)
\end{scheme}
...
\begin{scheme}
(else \hyperi{expression} \hyperii{expression} \ldots)\rm.
\end{scheme}
\mainschindex{else}
\mainschindex{=>}
...
\begin{entry}{
\proto{case}{ \hyper{key} \hyperi{clause} \hyperii{clause} \ldots}{\exprtype}}

\syntax
\hyper{Key} can be any expression.  Each \hyper{clause} has
the form
\begin{scheme}
((\hyperi{datum} \ldots) \hyperi{expression} \hyperii{expression} \ldots)\rm,
\end{scheme}
...
\begin{scheme}
((\hyperi{datum} \ldots) => \hyper{expression})
\end{scheme}
The last \hyper{clause} can be an ``else clause,'' which has one of the forms
\begin{scheme}
(else \hyperi{expression} \hyperii{expression} \ldots)
\end{scheme}
or
\begin{scheme}
...
\begin{entry}{
\proto{and}{ \hyperi{test} \ldots}{\exprtype}}
...
\begin{entry}{
\proto{or}{ \hyperi{test} \ldots}{\exprtype}}
...
\begin{entry}{
\proto{when}{ \hyper{test} \hyperi{expression} \hyperii{expression} \ldots}{\exprtype}}
...
\begin{entry}{
\proto{unless}{ \hyper{test} \hyperi{expression} \hyperii{expression} \ldots}{\exprtype}}
...
\begin{entry}{
\proto{cond-expand}{ \hyperi{ce-clause} \hyperii{ce-clause} \ldots}{\exprtype}}
...
{\tt(\hyper{feature requirement} \hyper{expression} \ldots)}

The last clause can be an ``else clause,'' which has the form

{\tt(else \hyper{expression} \ldots)}
...
\item {\tt(and \hyper{feature requirement} \ldots)}
\item {\tt(or \hyper{feature requirement} \ldots)}
...
\begin{scheme}
((\hyperi{variable} \hyperi{init}) \ldots)\rm,
\end{scheme}
...
\begin{scheme}
((\hyperi{formals} \hyperi{init}) \ldots)\rm,
\end{scheme}
...
\hyper{Mv binding spec} has the form
\begin{scheme}
((\hyper{formals} \hyper{init}) \ldots)\rm,
\end{scheme}
...
\begin{entry}{
\proto{begin}{ \hyper{expression or definition} \ldots}{\exprtype}}
...
\begin{entry}{
\rproto{begin}{ \hyperi{expression} \hyperii{expression} \ldots}{\exprtype}}
...
\mainschindex{do}{\tt\obeyspaces
     \ldots)\\
    (\hyper{test} \hyper{expression} \ldots)\\
  \hyper{command} \ldots)}
...
\begin{entry}{
\pproto{(parameterize ((\hyperi{param} \hyperi{value}) \ldots)}{syntax}
{\tt\obeyspaces
\hyper{body})}}
...
{\tt\obeyspaces
\hyperi{cond clause} \hyperii{cond clause} \ldots)\\
\hyper{body})}\\
}
\mainschindex{guard}
...
\begin{entry}{
\proto{case-lambda}{ \hyper{clause} \ldots}{case-lambda library syntax}}
...
\hyper{Bindings} has the form
\begin{scheme}
((\hyper{keyword} \hyper{transformer spec}) \ldots)
\end{scheme}
...
\begin{entry}{
\pproto{(syntax-rules (\hyper{literal} \ldots)}{\exprtype}
{\tt\obeyspaces
\hyper{syntax rule} \ldots)\\
}
\pproto{(syntax-rules \hyper{ellipsis} (\hyper{literal} \ldots)}{\exprtype}
{\tt\obeyspaces
\hyper{syntax rule} \ldots)}\\
\pproto{\_}{\auxiliarytype}
\pproto{\ldots}{\auxiliarytype}}
\mainschindex{_}
...
Identifiers that appear in \texttt{(\hyper{literal} \ldots)} are
...
\item $P$ is of the form
      {\cf ($P_1$ $\dots$ $P_k$ $P_e$ \meta{ellipsis} $P_{m+1}$ \ldots{} $P_n$)}
      where $E$ is
...
\item $P$ is of the form
      {\cf ($P_1$ $\dots$ $P_k$ $P_{e}$ \meta{ellipsis} $P_{m+1}$ \ldots{} $P_n$ . $P_x$)}
      where $E$ is
...
\item $P$ is of the form
      {\cf \#($P_1$ $\dots$ $P_k$ $P_{e}$ \meta{ellipsis} $P_{m+1}$ \ldots $P_n$)}
...
\begin{entry}{
\pproto{(syntax-error \hyper{message} \hyper{args} \ldots)}{\exprtype}}
...
At the outermost level of a program, {\tt(begin \hyperi{expression or definition} \ldots)} is
equivalent to the sequence of expressions and definitions
in the \ide{begin}.
Similarly, in a \hyper{body}, {\tt(begin \hyperi{definition} \ldots)} is equivalent
to the sequence \hyperi{definition} \ldots.
...
\item {\tt(only \hyper{import set} \hyper{identifier} \ldots)}
\item {\tt(except \hyper{import set} \hyper{identifier} \ldots)}
\item {\tt(prefix \hyper{import set} \hyper{identifier})}
\item {\tt(rename \hyper{import set}\\
{\obeyspaces
\hspace*{4em}(\hyperi{identifier} \hyperii{identifier}) \ldots)}}
\end{itemize}
...
{\tt(begin \hyperi{definition} \ldots)}
...
\hspace*{4em}{\tt \hyper{constructor} \hyper{pred} \hyper{field} \ldots})}

\syntax
\hyper{name} and \hyper{pred} are identifiers.
The \hyper{constructor} is of the form
\begin{scheme}
(\hyper{constructor name} \hyper{field name} \ldots)
\end{scheme}
...
\item \hyper{constructor name} is bound to a procedure that takes as
  ...
  \texttt{(\hyper{constructor name} \ldots)} subexpression and returns a
...
(define-library \hyper{library name}
  \hyper{library declaration} \ldots)
\end{scheme}
...
\item{\tt(export \hyper{export spec} \ldots)}

\item{\tt(import \hyper{import set} \ldots)}

\item{\tt(begin \hyper{command or definition} \ldots)}

\item{\tt(include \hyperi{filename} \hyperii{filename} \ldots)}

\item{\tt(include-ci \hyperi{filename} \hyperii{filename} \ldots)}

\item{\tt(include-library-declarations \hyperi{filename} \hyperii{filename} \ldots)}

\item{\tt(cond-expand \hyperi{ce-clause} \hyperii{ce-clause} \ldots)}
...
\begin{entry}{
\proto{=}{ \vri{z} \vrii{z} \vriii{z} \ldots}{procedure}
\proto{<}{ \vri{x} \vrii{x} \vriii{x} \ldots}{procedure}
\proto{>}{ \vri{x} \vrii{x} \vriii{x} \ldots}{procedure}
\proto{<=}{ \vri{x} \vrii{x} \vriii{x} \ldots}{procedure}
\proto{>=}{ \vri{x} \vrii{x} \vriii{x} \ldots}{procedure}}
...
\begin{entry}{
\proto{max}{ \vri{x} \vrii{x} \ldots}{procedure}
\proto{min}{ \vri{x} \vrii{x} \ldots}{procedure}}
...
\rproto{-}{ \vri{z} \vrii{z} \ldots}{procedure}
\proto{/}{ \vr{z}}{procedure}
\rproto{/}{ \vri{z} \vrii{z} \ldots}{procedure}}
...
\begin{entry}{
\proto{gcd}{ \vri{n} \ldots}{procedure}
\proto{lcm}{ \vri{n} \ldots}{procedure}}
...
\begin{entry}{
\proto{boolean=?}{ \vari{boolean} \varii{boolean} \variii{boolean} \ldots}{procedure}}
...
\begin{entry}{
\proto{list}{ \var{obj} \ldots}{procedure}}
...
\begin{entry}{
\proto{symbol=?}{ \vari{symbol} \varii{symbol} \variii{symbol} \ldots}{procedure}}
...
\begin{entry}{
\proto{char=?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{procedure}
\proto{char<?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{procedure}
\proto{char>?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{procedure}
\proto{char<=?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{procedure}
\proto{char>=?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{procedure}}
...
\begin{entry}{
\proto{char-ci=?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{char library procedure}
\proto{char-ci<?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{char library procedure}
\proto{char-ci>?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{char library procedure}
\proto{char-ci<=?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{char library procedure}
\proto{char-ci>=?}{ \vri{char} \vrii{char} \vriii{char} \ldots}{char library procedure}}
...
\begin{entry}{
\proto{string}{ char \ldots}{procedure}}
...
\begin{entry}{
\proto{string=?}{ \vri{string} \vrii{string} \vriii{string} \ldots}{procedure}}
...
\begin{entry}{
\proto{string-ci=?}{ \vri{string} \vrii{string} \vriii{string} \ldots}{char library procedure}}
...
\begin{entry}{
\proto{string-append}{ \var{string} \ldots}{procedure}}
...
Vectors are written using the notation {\tt\#(\var{obj} \ldots)}.
...
\begin{entry}{
\proto{vector}{ obj \ldots}{procedure}}
...
\begin{entry}{
\proto{vector-append}{ \var{vector} \ldots}{procedure}}
...
Bytevectors are written using the notation {\tt\#u8(\var{byte} \ldots)}.
...
\begin{entry}{
\proto{bytevector}{ \var{byte} \ldots}{procedure}}
...
\begin{entry}{
\proto{bytevector-append}{ \var{bytevector} \ldots}{procedure}}
...
{\cf(append (list \vari{arg} \ldots) \var{args})} as the actual
arguments.
...
\begin{entry}{
\proto{map}{ proc \vari{list} \varii{list} \ldots}{procedure}}
...
\begin{entry}{
\proto{string-map}{ proc \vari{string} \varii{string} \ldots}{procedure}}
\label{stringmap}
...
\begin{entry}{
\proto{vector-map}{ proc \vari{vector} \varii{vector} \ldots}{procedure}}
...
\begin{entry}{
\proto{for-each}{ proc \vari{list} \varii{list} \ldots}{procedure}}
...
\begin{entry}{
\proto{string-for-each}{ proc \vari{string} \varii{string} \ldots}{procedure}}
...
\begin{entry}{
\proto{vector-for-each}{ proc \vari{vector} \varii{vector} \ldots}{procedure}}
...
\begin{entry}{
\proto{environment}{ \vri{list} \ldots}{eval library procedure}}
\label{environments}

...
<a id='type__r7rs__inexact-integer'></a>

# `inexact-integer` -- `r7rs` Types


<a id='type__r7rs__inexact-integer__super-types'></a>
...
<a id='type__r7rs__inexact-integer__super-types-recursive'></a>
...
<a id='type__r7rs__inexact-integer__predicate'></a>

#### Predicate

````
(lambda (value) (and (integer? value) (inexact? value)))
````


<a id='type__r7rs__inexact-integer__categories'></a>
...
<a id='type__r7rs__inexact-integer__categories-recursive'></a>

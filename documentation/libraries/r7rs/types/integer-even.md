...
<a id='type__r7rs__integer-even'></a>

# `integer-even` -- `r7rs` Type


<a id='type__r7rs__integer-even__super-types'></a>
...
<a id='type__r7rs__integer-even__super-types-recursive'></a>
...
<a id='type__r7rs__integer-even__referent-definitions-input'></a>
...
<a id='type__r7rs__integer-even__referent-definitions-input-recursive'></a>
...
<a id='type__r7rs__integer-even__predicate'></a>

#### Predicate

````
(lambda (value) (and (integer? value) (even? value)))
````


<a id='type__r7rs__integer-even__categories'></a>
...
<a id='type__r7rs__integer-even__categories-recursive'></a>

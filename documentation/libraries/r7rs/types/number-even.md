...
<a id='type__r7rs__number-even__super-types-recursive'></a>
...
<a id='type__r7rs__number-even__referent-definitions-input'></a>
...
<a id='type__r7rs__number-even__referent-definitions-input-recursive'></a>
...
<a id='type__r7rs__number-even__predicate'></a>

#### Predicate

````
(lambda (value) (and (number? value) (even? value)))
````


<a id='type__r7rs__number-even__categories'></a>
...
<a id='type__r7rs__number-even__categories-recursive'></a>

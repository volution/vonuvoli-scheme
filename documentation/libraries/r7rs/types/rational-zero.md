...
<a id='type__r7rs__rational-zero'></a>

# `rational-zero` -- `r7rs` Type


<a id='type__r7rs__rational-zero__sub-types-tree'></a>
...
<a id='type__r7rs__rational-zero__super-types'></a>
...
<a id='type__r7rs__rational-zero__super-types-recursive'></a>
...
<a id='type__r7rs__rational-zero__sub-types'></a>
...
<a id='type__r7rs__rational-zero__sub-types-recursive'></a>
...
<a id='type__r7rs__rational-zero__referent-definitions-input'></a>
...
<a id='type__r7rs__rational-zero__referent-definitions-input-recursive'></a>
...
<a id='type__r7rs__rational-zero__predicate'></a>

#### Predicate

````
(lambda (value) (and (rational? value) (zero? value)))
````


<a id='type__r7rs__rational-zero__categories'></a>
...
<a id='type__r7rs__rational-zero__categories-recursive'></a>
